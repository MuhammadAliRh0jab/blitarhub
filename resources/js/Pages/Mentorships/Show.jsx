            ...
            <div className="min-h-screen bg-gray-100 font-sans">
                <nav className="bg-white shadow-sm py-3 px-6 sticky top-0 z-50">
                    <div className="max-w-5xl mx-auto flex justify-between items-center">
                        ...
                        <div className="space-x-5 font-medium text-gray-600 hidden md:flex items-center text-sm">
                            ...
                            <Link href={route('scholarships.index')} className="hover:text-blue-600 transition">Scholarships</Link>
                        </div>
                    </div>
                </nav>
                ...
                <div className="max-w-5xl mx-auto px-4 py-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200 mb-6">
                        <div className="h-44 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 relative">
                            <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black/20 to-transparent"></div>
                        </div>
                        <div className="px-8 pb-8 relative">
                            <div className="flex items-end -mt-14 mb-6">
                                <div className="w-28 h-28 rounded-2xl border-4 border-white bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center text-blue-600 font-bold text-4xl shadow-xl flex-shrink-0">
                                    {mentor.name.charAt(0)}
                                </div>
                                <div className="ml-6 pb-1 flex-1">
                                    <h1 className="text-3xl mb-6 font-extrabold text-gray-900">{mentor.name}</h1>
                                    <p className="text-lg text-blue-600 font-semibold mt-6">{mentor.expertise}</p>
                                ...
                                <div className="flex space-x-3 pb-1">
                                    <button className="bg-blue-600 text-white px-6 py-2.5 rounded-full font-bold shadow-lg shadow-blue-200 hover:bg-blue-700 transition">Booking Sesi</button>
                                    <button className="border-2 border-gray-300 text-gray-700 px-6 py-2.5 rounded-full font-bold hover:border-blue-600 hover:text-blue-600 transition">Hubungi</button>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200">
                                <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                                    <span className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center mr-3 text-blue-600">👤</span>Tentang Mentor
                                </h2>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200">
                                <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                                    <span className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center mr-3 text-blue-600">📚</span>Program Mentorship
                                </h2>
                                <div className="space-y-4">
                                    {mentor.programs?.map(p => (
                                        <div key={p.id} className="border border-gray-200 rounded-xl p-6 hover:border-blue-300 hover:shadow-md transition">
                                            <div className="flex justify-between items-start mb-3">
                                                <h3 className="text-lg font-bold text-gray-900">{p.title}</h3>
                                                <span className="bg-blue-100 text-blue-800 font-bold px-3 py-1 rounded-full text-sm">{p.price}</span>
                                            </div>
                                            ...
                                            <button className="mt-4 w-full bg-gray-900 text-white py-2.5 rounded-xl font-bold hover:bg-blue-600 transition">Daftar Sekarang</button>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200">
                                <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                                    <span className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center mr-3 text-blue-600">💼</span>Pengalaman Kerja
                                </h2>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200">
                                <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                                    <span className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center mr-3 text-blue-600">🎓</span>Pendidikan
                                </h2>
                        ...
                        <div className="space-y-6">
                                    ...
                                    {mentor.testimonials?.map((t, i) => (
                                        <div key={i} className="border-b border-gray-50 pb-4 last:border-0 last:pb-0">
                                            <div className="flex items-center space-x-2 mb-2">
                                                <div className="w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center text-xs font-bold text-blue-600">{t.name.charAt(0)}</div>
                                                <div>
                            ...
                            <div className="bg-blue-600 rounded-2xl shadow-sm p-6 text-white">
                                ...
                                <p className="text-blue-100 text-sm mb-5">Mulai perjalanan karirmu bersama {mentor.name.split(' ')[0]} sekarang.</p>
                                <button className="w-full bg-white text-blue-600 py-3 rounded-xl font-bold shadow hover:shadow-lg hover:scale-105 transition-all duration-300">Booking Sesi Pertama</button>
                            </div>
                        </div>
                    </div>
                    <div className="mt-10 text-center">
                        <Link href={route('mentorships.index')} className="text-blue-600 font-semibold hover:underline">← Kembali ke Mentorship Hub</Link>
                    </div>
                </div>
            </div>
        </>
