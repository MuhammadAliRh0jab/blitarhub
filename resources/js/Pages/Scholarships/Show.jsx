                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
                                <div className="h-56 bg-gradient-to-br from-rose-400 via-pink-500 to-orange-400 flex items-center justify-center relative">
                                ...
                                <div className="p-8">
                                    ...
                                    <p className="text-sm text-gray-500 mb-6">Oleh: <span className="font-bold text-orange-600">{campaign.organizer}</span></p>
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                                            <div className="bg-gradient-to-r from-orange-500 to-rose-500 h-3 rounded-full transition-all duration-1000" style={{ width: `${progress}%` }}></div>
                                        </div>
                                    ...
                                    <button className="w-full bg-orange-600 text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-orange-200 hover:bg-orange-700 hover:shadow-xl transition-all">
                                        💝 Donasi Sekarang
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200">
                                <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                                    <span className="w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center mr-3">📖</span>Cerita Campaign
                                </h2>
                                <p className="text-gray-700 leading-relaxed whitespace-pre-line">{campaign.description}</p>
                                <div className="mt-6 p-4 bg-orange-50 rounded-xl border border-orange-100">
                                    <p className="text-sm text-gray-700"><span className="font-bold">Penerima Manfaat:</span> <span className="text-orange-600 font-bold">{campaign.beneficiary}</span></p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200">
                                <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                                    <span className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center mr-3">📢</span>Kabar Terbaru
                                </h2>
                        ...
                        <div className="space-y-6">
                                    ...
                                    {campaign.donor_list?.map((d, i) => (
                                        <div key={i} className="border-b border-gray-50 pb-4 last:border-0 last:pb-0">
                                            <div className="flex items-center justify-between mb-1">
                                                ...
                                                <div className="text-sm font-bold text-orange-600">Rp {d.amount.toLocaleString()}</div>
                                            </div>
                                            {d.message && (
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-200 text-center">
                                ...
                                <div className="flex justify-center space-x-3">
                                    <button className="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center font-bold text-sm hover:scale-110 transition">W</button>
                                    <button className="w-10 h-10 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold text-sm hover:scale-110 transition">F</button>
