...
export default function ManageMentorExperience({ isMentor, className = '' }) {
    ...
    const submit = (e) => {
        ...
        post(route('profile.mentor-experience.store'), {
            preserveScroll: true,
            onSuccess: () => reset(),
        });
    };
        ...
        <section className={className}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    Tambahkan riwayat karir Anda sebagai Mentor.
                </p>
            </header>
