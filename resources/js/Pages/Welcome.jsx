    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white flex flex-col font-sans selection:bg-orange-100 selection:text-orange-900">
                ...
                <nav className="bg-white/80 backdrop-blur-md border-b border-gray-100 py-4 px-6 fixed w-full top-0 z-50">
                    <div className="max-w-7xl mx-auto flex justify-between items-center">
                        ...
                        <div className="hidden md:flex space-x-8 font-semibold text-gray-500">
                            ...
                            <Link href={route('mentorships.index')} className="hover:text-blue-600 transition">Mentor Hub</Link>
                ...
                <section className="pt-32 pb-16 px-6 lg:pt-48 lg:pb-32 bg-gradient-to-b from-orange-50/50 to-white overflow-hidden">
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                        <div className="text-center lg:text-left z-10">
                            ...
                            <h1 className="text-5xl md:text-5xl font-black tracking-tight text-gray-900 mb-8 leading-[1.1]">
                                Temukan <span className="text-orange-600">Talenta Terbaik</span> <br /> 
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative">
                        <div className="flex justify-between items-end mb-12">
                            ...
                            <div className="flex items-center space-x-3">
                                <button onClick={() => scrollManual(talentRef, 'prev')} className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all shadow-sm">←</button>
                                <button onClick={() => scrollManual(talentRef, 'next')} className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all shadow-sm">→</button>
                            </div>
                        </div>
                            ...
                            <div ref={talentRef} className="flex space-x-6 overflow-x-auto pb-8 snap-x snap-mandatory scroll-smooth scrollbar-hide -mx-6 px-6">
                                {featuredTalents?.map((t, idx) => (
                                    <Link key={t.id} href={route('talents.show', t.id)} className="flex-none w-[75%] md:w-[calc(25%-18px)] snap-start group/talent">
                                        <div className="bg-gray-50 rounded-3xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl hover:border-blue-200 hover:bg-white p-4 relative h-full flex flex-col">
                                            <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm px-2 py-1 rounded-lg border border-gray-100 text-[10px] font-black text-blue-600 shadow-sm z-20">⭐ {t.rating}</div>
                                            <div className="w-full aspect-square mb-4 bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl overflow-hidden relative flex-none">
                                                <img 
                                            ...
                                            <div className="flex flex-col flex-1 px-2">
                                                ...
                                                <p className="text-[10px] font-bold text-blue-600 mb-4 line-clamp-1 truncate">{t.headline}</p>
                                                ...
                                                <div className="flex justify-between items-center pt-3 border-t border-gray-100 mt-auto">
                                                    ...
                                                    <div className="w-6 h-6 rounded-full bg-blue-600 flex items-center justify-center text-white text-xs font-black opacity-0 group-hover/talent:opacity-100 transition-opacity">→</div>
                                                </div>
                                            </div>
                                        </div>
                                    </Link>
                ...
                <section className="py-24 bg-blue-50/50 border-y border-blue-100 overflow-hidden">
                    <div className="max-w-7xl mx-auto px-6 relative">
                        <div className="flex justify-between items-end mb-12">
                            <div>
                            ...
                            <div className="flex items-center space-x-3">
                                <button onClick={() => scrollManual(mentorRef, 'prev')} className="w-10 h-10 rounded-full border border-blue-200 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all shadow-sm">←</button>
                                <button onClick={() => scrollManual(mentorRef, 'next')} className="w-10 h-10 rounded-full border border-blue-200 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all shadow-sm">→</button>
                            </div>
                        </div>
                            ...
                            <div ref={mentorRef} className="flex space-x-6 overflow-x-auto pb-8 snap-x snap-mandatory scroll-smooth scrollbar-hide -mx-6 px-6">
                                {featuredMentors?.map((m, idx) => (
                                    <Link key={m.id} href={route('mentorships.show', m.id)} className="flex-none w-[75%] md:w-[calc(25%-18px)] snap-start group/mentor">
                                        <div className="bg-white rounded-3xl overflow-hidden border border-blue-100 transition-all duration-300 hover:shadow-xl hover:border-blue-300 p-4 relative h-full flex flex-col">
                                            <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm px-2 py-1 rounded-lg border border-gray-100 text-[10px] font-black text-blue-600 shadow-sm z-20">⭐ {m.rating}</div>
                                            <div className="w-full aspect-square mb-4 bg-blue-100 border-2 border-white rounded-2xl overflow-hidden relative flex-none shadow-sm">
                                                <img 
                                            ...
                                            <div className="flex flex-col flex-1 px-2">
                                                ...
                                                <div className="bg-blue-50 p-2.5 rounded-xl mb-4 group-hover/mentor:bg-blue-600 transition-colors">
                                                    <p className="text-[9px] font-black text-blue-700 group-hover/mentor:text-white transition-colors uppercase tracking-[0.15em] line-clamp-1">{m.expertise}</p>
                                                </div>
                                                
                                                <div className="flex justify-between items-center pt-3 border-t border-blue-50 mt-auto">
                                                    <div className="text-[10px] font-bold text-gray-400 capitalize">{m.mentees} Mentees</div>
                                                    <div className="text-[10px] font-black text-blue-600 group-hover/mentor:translate-x-1 transition-transform">Masuk Hub →</div>
                                                </div>
                                            </div>
                                        </div>
                                    </Link>
                                ...
                                <div className="bg-white rounded-[3rem] p-8 md:p-12 border border-orange-100 shadow-[0_32px_64px_-16px_rgba(249,115,22,0.1)] relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10">
                                        <div className="mb-10 text-left">
                                            <div className="text-gray-400 text-xs font-black uppercase tracking-widest mb-3">Total Dana Terkumpul</div>
                                            <div className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-8">Rp {totalDonated.toLocaleString()}</div>
                                            
                                            <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
                                                <div className="w-full bg-gray-200 rounded-full h-3 mb-4 overflow-hidden">
                                                    <div className="bg-orange-500 h-full rounded-full transition-all duration-1000" style={{ width: `${donationProgress}%` }}></div>
                                                </div>
                                                <div className="flex justify-between items-center">
                                                    <div>
                                                        <div className="text-2xl font-black text-gray-900 leading-none">Rp {totalDonated.toLocaleString()}</div>
                                                        <div className="text-[10px] uppercase font-black text-gray-400 mt-1 tracking-widest text-left">Terkumpul</div>
                                                    </div>
                                                    <div className="text-right">
                                                        <div className="text-xl font-black text-orange-600 leading-none">{donationProgress}%</div>
                                                        <div className="text-[10px] uppercase font-black text-gray-400 mt-1 tracking-widest">Target tercapai</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
                                            <Link href={route('scholarships.index')} className="bg-orange-600 text-white px-8 py-5 rounded-2xl font-black text-lg text-center hover:bg-orange-700 hover:shadow-2xl hover:shadow-orange-200 transition-all active:scale-95 flex-1 flex items-center justify-center">Donasi Sekarang</Link>
                                            <Link href={route('scholarships.request')} className="bg-white text-orange-600 border-2 border-orange-600 px-8 py-5 rounded-2xl font-black text-lg text-center hover:bg-orange-50 transition-all active:scale-95 flex-1 flex items-center justify-center">Ajukan Permohonan</Link>
                                            <div className="px-6 py-5 rounded-2xl bg-gray-50 text-[10px] text-gray-400 font-bold border border-gray-100 flex items-center justify-center flex-1 text-center leading-tight">Laporan Transparansi tersedia secara mingguan.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-12 mt-20">
                            {[
                                ...
                                { quote: "Mentoring dengan pakar industri benar-benar merubah pola pikir saya dalam berkarir. Sekarang saya merasa jauh lebih percaya diri menghadapi tantangan global.", name: 'Anisa Larasati', role: 'Product Manager', color: 'orange', age: '26 years old' },
                                { quote: "Sistem transparansi donasinya sangat membantu saya sebagai donatur merasa tenang. Saya bisa melihat langsung dampak nyata dari bantuan saya.", name: 'Haji Rahmat', role: 'Donatur Tetap', color: 'orange', age: '52 years old' },
                            ].map((t, idx) => (
